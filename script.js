document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      if (field.type === 'submit' || field.type === 'button' || field.type === 'reset') return true;
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.getAttribute('data-success-message') ||
      ...
      if (actionUrl && actionUrl !== '#') {
        fetch(actionUrl, {
          ...
          .catch(function () {
            ...
            const errorMsg = contactForm.getAttribute('data-error-message') ||
              'Something went wrong. Please try again.';
            showFormSuccess(contactForm, errorMsg, true);
          });
      } else {
        showFormSuccess(contactForm, successMessage);
      }
    ...
    const showFormSuccess = function (form, message, isError) {
      ...
      successEl.classList.toggle('form-success-error', !!isError);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '36ecbb88-420e-4827-9054-b21ed79a7128',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '36ecbb88-420e-4827-9054-b21ed79a7128';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '36ecbb88-420e-4827-9054-b21ed79a7128';
